...
Guide for developers contributing to CMDB KubeExplorer or building custom versions.
...
| Docker | `make release-docker` | `ghcr.io/cmdb/kubeexplorer:VERSION` |
...
4. Update Helm chart `appVersion` in `deploy/helm/cmdb-kubeexplorer/Chart.yaml`
